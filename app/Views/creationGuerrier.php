...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if(isset($_POST['hero_name']) && isset($_POST['hero_biography'])){
            ...
            $hero_biography = $_POST['hero_biography'];
            ...
            $special_attack = $guerrier->getSpell_id();
            $xp = 0;
            ...
            $mainRequete = $client->prepare("INSERT INTO hero (name, class_id, user_id, image, biography, pv, mana, strength, initiative, armor, primary_weapon, spell_id, xp)
                                                VALUES (:name, :class_id, :user_id, :image, :biography, :pv, :mana, :strength, :initiative, :armor, :primary_weapon, :spell_id, :xp)");
            ...
            $mainRequete->bindParam(':spell_id', $special_attack);
